...
contract DominantAssuranceContract {
    ...
    mapping(address => uint256) public pledgerBalance;
    ...
    //constructor
    constructor (uint256 _pledgeCountGoal, uint256 _pledgeAmount, uint256 _refundPercentage, uint256 _campaignLength) public {
        entrepreneur = msg.sender;
        active = true;
        pledgeAmount = _pledgeAmount;
        pledgeCountGoal = _pledgeCountGoal;
        refundPercentage = _refundPercentage;
        pledgeDeadline = now + (_campaignLength * 1 minutes);
    }
    ...
    function claimFunds() public {
        ...
        require(now > pledgeDeadline, "The campaign is not over yet");
    ...
    function getRefund() public {
        require(now > pledgeDeadline, "The campaign is not over");
